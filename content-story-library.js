...
function renderStoryLibrary() {
  ...
  ui.editorPanel.innerHTML = `<div class="writer-header"><div><span class="eyebrow">STORY LIBRARY</span><h2>이야기 모아보기</h2><p>기존 월드의 원고와 새 이야기를 지역별로 찾아보세요. 장면을 누르면 바로 편집할 수 있습니다.</p></div>${btn('새 이야기 쓰기','libraryNew','primary')}</div>
